...
- **25+ 分析模块**：公司全景 · 团队股权 · 关键人风险 · 财务三表 · 护城河 · 空头剧本 · 催化剂 · 风险矩阵 · 竞争格局 · 赛道 TAM · 雷达图 · 双时间轴情景 · 加权期望 · 下行风险量化 · 历史估值分位 · 敏感度 Tornado · SOTP · Kelly 仓位 · 组合相关性 · 对冲建议
- **7 步方法论**：事实锚定 → 十倍基因体检 → 合同积压 → 竞品对照 → 双时间轴情景 → 加权期望 → 观察指标
