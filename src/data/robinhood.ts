        ...
        competitors: [
            {
                ...
                type: 'specialist',
                ticker: 'HOOD',
                revenue2026E: '$5.0-5.5B',
                aiRevenue: '交易 58% · NII 34% · 订阅 8%',
                gpuFleet: '27.4M 客户 · $307B AUC',
                backlog: 'Trump Accounts + MIAXdx + Event Contracts',
                ebitdaMargin: '~42%',
                marketCap: '~$69.5B',
                nvidiaLevel: 5,
                threat: 'low',
                strength: '千禧心智 · Super App · 预测市场 · Trump Accounts 18 年护城河',
                weakness: 'PFOF 依赖 · 美国集中 · 加密 -47% 拖累',
            },
            {
                name: 'Charles Schwab',
                type: 'hyperscaler',
                ticker: 'SCHW',
                revenue2026E: '~$22B',
                aiRevenue: 'NII 65% · 资产管理 25%',
                gpuFleet: '46.5M 账户 · $11.9T AUC',
                backlog: '401(k) + Schwab Crypto Q2 launch',
                ebitdaMargin: '~45%',
                marketCap: '~$170B',
                nvidiaLevel: 4,
                threat: 'high',
                strength: '规模碾压 · 机构 + 401(k) 渠道 · 品牌信任',
                weakness: '年轻用户弱 · 加密晚 5 年 · App 体验陈旧',
            },
            {
                name: 'Fidelity (私有)',
                type: 'hyperscaler',
            ...
            },
            {
                ...
                weakness: '非加密资产弱 · UX 专业化 · Q1 净亏 $394M',
            },
            {
                name: 'SoFi',
                type: 'specialist',
