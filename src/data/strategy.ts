...
export const strategy: CompanyDetail = {
    ...
    scenarios: [
        {
            name: '超级牛市: Hyperbitcoinization + 美国战略储备 (BTC 5Y $400K / 10Y $1M+)',
            cls: 'bull',
            prob: 15,
            y5Mcap: '$700 – 1,000B',
            y5Value: 850,
            y10Mcap: '$1.8 – 2.5T',
            y10Value: 2000,
            desc: 'BTC 成全球储备资产 / 美国战略储备落地；mNAV 回到 1.8-2.5x；持仓 1.5M BTC × $400K + 飞轮全速；BTC/share 5Y 增厚 2x、10Y 3x；MSTR 成为加密界"伯克希尔"',
        },
        {
            name: '基线: BTC 主流化 + mNAV 回归到 1.2-1.5x (5Y $200K / 10Y $400K)',
            cls: 'bull',
            prob: 40,
            y5Mcap: '$200 – 260B',
            y5Value: 230,
            y10Mcap: '$550 – 750B',
            y10Value: 650,
            desc: '加密机构化 + 美国监管友好；mNAV 从 0.97x 回到 1.2-1.5x（均值回归）；持仓 1.2-1.4M BTC × $200K；BTC per share 5Y +50% / 10Y +120%；优先股飞轮稳态运转',
        },
        {
            name: '横盘: BTC 失速 + mNAV 维持 0.9-1.1x (5Y $120K / 10Y $200K)',
            cls: 'neutral',
            prob: 30,
            y5Mcap: '$90 – 130B',
            y5Value: 110,
            y10Mcap: '$180 – 260B',
            y10Value: 220,
            desc: 'BTC 突破乏力，mNAV 维持 0.9-1.1x；持仓 1.0-1.1M BTC × $120K；ATM 收紧；BTC per share 仅微增；MSTR 沦为"BTC + 0-10% 溢价/折价"工具',
        },
        {
            name: '熊市: 飞轮反向 + Saylor 卖 BTC 服务股息 (5Y BTC $40K / 10Y $50K)',
            cls: 'bear',
            prob: 12,
            y5Mcap: '$15 – 25B',
            y5Value: 20,
            y10Mcap: '$20 – 30B',
            y10Value: 25,
            desc: 'BTC 持续 18+ 月低于 $60K → Saylor 强制减持 BTC 服务 $1.5B 股息 → BTC per share 反向；mNAV 跌至 0.5-0.7x；持仓 600K-700K BTC（被迫减持）；股价 -85%',
        },
        {
            name: '死亡螺旋: 极端熊 + 优先股违约 (5Y BTC $25K / 10Y $30K)',
            cls: 'bear',
            prob: 3,
            y5Mcap: '$3 – 8B',
            y5Value: 5,
    ...
    weightedExpectation: {
        ...
        breakdown: [
            { scenario: 'A. 超级牛市', prob: 15, y5Mid: 850, y10Mid: 2000, y5Contrib: 127.5, y10Contrib: 300 },
            { scenario: 'B. 基线', prob: 40, y5Mid: 230, y10Mid: 650, y5Contrib: 92, y10Contrib: 260 },
            { scenario: 'C. 横盘', prob: 30, y5Mid: 110, y10Mid: 220, y5Contrib: 33, y10Contrib: 66 },
            { scenario: 'D. 熊市', prob: 12, y5Mid: 20, y10Mid: 25, y5Contrib: 2.4, y10Contrib: 3 },
            { scenario: 'E. 死亡螺旋', prob: 3, y5Mid: 5, y10Mid: 5, y5Contrib: 0.15, y10Contrib: 0.15 },
        ],
    },
    ...
    finalQuote:
        '<strong>关键反转：当前 mNAV 0.97x 是 mNAV 套利窗口，加权期望 vs 被动从 -2.2pp 反转为 +17.6pp（10Y）/ +23.6pp（5Y）</strong>——这与 2025-Q4 mNAV 1.5x+ 时分析完全相反。**核心修正**：① 股价 $186.90 vs 每股 BTC 价值 $192.66 = **折价 3% 直接买 BTC + 飞轮锁定**；② CAMT 风险已被 IRS Notice 2025-49 / 2026-7 豁免（之前担忧的 21% / 15% 税收阻力已不成立）；③ BTC per share 飞轮真实有效（2025 +22.8% / 2026 YTD +9.6%）；④ 当前持仓从 597K → 818,334 BTC（5 个月 +37%）。**最大风险**：$1.5B/年优先股股息义务 + 18 个月覆盖期；Saylor 2026-05-05 首次承认可能卖 BTC 服务股息（飞轮叙事关键裂缝）；Q1 2026 净亏 -$12.54B 显示 fair value 会计放大波动。**仓位建议**：在当前 mNAV 0.97x 折价区间 = bullish（2-4% 仓位）；若 mNAV 涨回 1.5x 应 trim；若 mNAV 跌至 0.5x 是死亡螺旋警告。**与档案库其他标的对比**：5Y 期望 3.91x 仅次于 Nebius；vs 被动 +17.6pp 是档案库当前覆盖**第二高超额回报**（仅次 Nebius +16.8pp）。**校准记录**：本份分析修正了 2026-05-06 版本的"-2.2pp 跑输 IBIT" 结论——错误根源是基于 mNAV 1.5x 假设而非当前 0.97x 实况，且错误论述了"21% 即使不卖" 税收阻力（实际 CAMT 已豁免）。',
    ...
    valuation: {
        metrics: [
            ...
            { metric: 'Forward 5Y Mult (本分析)', value: '~3.91x', benchmark: '5Y CAGR 31.4%', read: 'cheap' },
            { metric: 'Forward 10Y Mult (本分析)', value: '~9.64x', benchmark: '10Y CAGR 25.4%', read: 'cheap' },
        ],
        sotp: [
    ...
    benchmarkComparison: {
        narrative:
            '**重大反转**：基于 mNAV 0.97x 当前折价区间 + CAMT 已豁免 + BTC per share 飞轮真实有效，MSTR 10Y 期望 CAGR 25.4% vs 被动组合 60% IBIT + 40% SPY (~14.8%) 的超额回报 = **+10.6pp**（与 2026-05-06 版本 -2.2pp 完全反转）。**核心修正**：之前分析基于 mNAV 1.5x 高位假设；现在 mNAV 0.97x 折价提供 mNAV 套利窗口；每股 BTC 折价 3% 直接买入 + BTC per share 飞轮（2025 +22.8%）+ mNAV 均值回归 = 三重 alpha。**机会成本基准比较**：vs IBIT 直接持有（18% CAGR）+ MSTR 在折价区间提供 +7.4pp alpha；vs 60% IBIT + 40% SPY (14.8%) +10.6pp；vs 60-40 SPY/国债 (7.8%) +17.6pp。',
        alternatives: [
            ...
            { name: '60% IBIT + 40% SPY', expectedReturn5Y: 13, expectedReturn10Y: 14.8, note: 'BTC 现货 + 美股宽基（关键基准）' },
        ...
        selfReturn10Y: 25.4,
        excessReturn5Y: 18.4,
        excessReturn10Y: 10.6,
        justifiesPosition: 'yes',
        takeaway:
            '**关键反转：MSTR 在 mNAV 0.97x 折价区间显著跑赢"60% IBIT + 40% SPY"被动组合 +10.6pp**。这是过去 28 个月罕见的 mNAV 套利窗口——既能拿到 BTC 折价 + 飞轮 alpha + mNAV 均值回归。**仓位调整**：mNAV < 1.0x 折价区间 = 2-4% bullish；mNAV 涨回 1.5x 应 trim 至 1.5-2%；mNAV > 2.5x 减仓至 0-0.5%。**与 IBIT 配合**：MSTR 2-3% + IBIT 1-2% = 加密暴露最优组合。',
    },
