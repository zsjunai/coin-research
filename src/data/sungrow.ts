...
export const sungrow: CompanyDetail = {
    ...
    weightedExpectation: {
        ...
        breakdown: [
            { scenario: 'A. 超级牛市 (储能爆发 + AI 数据中心 + 美国和解)', prob: 12, y5Mid: 8000, y10Mid: 12000, y5Contrib: 960, y10Contrib: 1440 },
            { scenario: 'B. 基线 (海外 65% + 储能稳健 + 美国零)', prob: 38, y5Mid: 4500, y10Mid: 6800, y5Contrib: 1710, y10Contrib: 2584 },
            { scenario: 'C. 横盘 (储能价格战 + 国内内卷加剧)', prob: 35, y5Mid: 3200, y10Mid: 4200, y5Contrib: 1120, y10Contrib: 1470 },
            { scenario: 'D. 熊市 (全球关税战 + 华为彻底夺份额)', prob: 12, y5Mid: 1800, y10Mid: 2200, y5Contrib: 216, y10Contrib: 264 },
            { scenario: 'E. 死亡螺旋 (Q1 -40% 持续 + 业绩崩塌)', prob: 3, y5Mid: 800, y10Mid: 1000, y5Contrib: 24, y10Contrib: 30 },
        ],
    },
