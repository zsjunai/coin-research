...
export const companies: CompanySummary[] = [
    ...
    },
    {
        ...
        market: 'US',
        currency: 'USD',
        desc: '全球最大上市公司 BTC 财库（**818,334 BTC · 占总供应 3.897%**）。2026-05-08 关键反转：股价从 $543 高点跌至 **$186.90 (-65%)**；**mNAV 从 2024-12 峰值 3.0x 压缩至 0.97x**——首次自 2024-01 以来 < 1.0x，是历史 5-10 分位罕见折价窗口；CAMT 风险已被 IRS Notice 2025-49 / 2026-7 豁免。**当前每股 BTC 价值 $192.66 vs 股价 $186.90 = 折价 3% 直接买 BTC + 飞轮（2025 BTC Yield +22.8%）+ mNAV 均值回归三重 alpha**。**vs 60-40 IBIT/SPY 被动组合超额 +10.6pp**（修正前 -2.2pp 是基于 mNAV 1.5x 假设）。最大风险：18 个月股息覆盖期 + Saylor 2026-05-05 首次承认可能卖 BTC 服务股息。',
        price: '~$186.90',
        marketCap: '~$65.27B',
        verdict: 'bullish',
        verdictText: 'Bullish / mNAV 折价区间分批建仓',
        metrics: [
            { label: '5Y 期望', value: '3.91x' },
            { label: '10Y 期望', value: '9.64x' },
            { label: 'P(10x · 10Y)', value: '~30%' },
            { label: 'vs 被动', value: '+17.6pp' },
        ],
