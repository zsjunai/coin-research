...
export const companies: CompanySummary[] = [
    ...
    },
    {
        ...
        market: 'US',
        currency: 'USD',
        desc: '全球第二大上市公司 ETH 财库。**2026-05-08 戏剧性反转**：股价 $7.31（从 $80 高点 -91%）/ 市值 $1.49B / **ETH 持仓 868,699 ETH**（vs 之前估的 580K · 占总供应 0.72%）/ **mNAV 0.74x = 深度折价 25%**（每股 ETH 价值 $10.28 vs 股价 $7.31）——是档案库当前覆盖**最深折价标的**。2026-02 改名 "Sharplink, Inc."，计划部署 ETH 到 ConsenSys Linea L2。Lubin 加密原生"教父级"叙事 + 兼职（主业 ConsenSys）。**核心修正**：之前用 ETH 18% 假设算 vs 被动 -2.1pp（档案库最差）；用 mNAV 0.74x 折价回归 + ETH CAGR 25-30% 修正后 → **vs 60-40 SPY/国债 +24.2pp**——从档案库最差 bearish 反转为**最深折价 bullish 标的**。',
        price: '~$7.31',
        marketCap: '~$1.49B',
        verdict: 'bullish',
        verdictText: 'Bullish / 深度折价 + 高方差',
        metrics: [
            { label: '5Y 期望', value: '7.32x' },
            { label: '10Y 期望', value: '16.1x' },
            { label: 'P(10x · 10Y)', value: '~50%' },
            { label: 'vs 被动', value: '+24.2pp' },
        ],
        tags: ['ETH 财库', '深度折价', 'Lubin', 'Linea L2', '小盘'],
        date: '2026-05-08',
    },
    {
        id: 'sungrow',
