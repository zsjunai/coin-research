...
export const nebius: CompanyDetail = {
    ...
    weightedExpectation: {
        ...
        breakdown: [
            { scenario: 'A. 超牛 (Mag 7 级 hyperscaler 不弃)', prob: 15, y5Mid: 300, y10Mid: 640, y5Contrib: 45, y10Contrib: 96 },
            { scenario: 'B. 基线 (按指引执行 + P/S 合理压缩)', prob: 40, y5Mid: 160, y10Mid: 240, y5Contrib: 64, y10Contrib: 96 },
            { scenario: 'C. 横盘 (增长减速 + 竞争激烈)', prob: 30, y5Mid: 60, y10Mid: 80, y5Contrib: 18, y10Contrib: 24 },
            { scenario: 'D. 熊市 (Hyperscaler Trap · MSFT/Meta 转自研)', prob: 12, y5Mid: 18, y10Mid: 20, y5Contrib: 2.16, y10Contrib: 2.4 },
            { scenario: 'E. 死亡螺旋 (内控失效 + 大客户撤单)', prob: 3, y5Mid: 5, y10Mid: 5, y5Contrib: 0.15, y10Contrib: 0.15 },
        ],
    },
